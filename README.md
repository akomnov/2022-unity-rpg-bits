...
Thus, this is not supposed to be complete - or even working at all - in any way, and is merely for demonstration purposes.
I barely had any familiarity with Unity or C# before working on this, and had to ramp up on the go, so this should give the potential employer an idea of what kind of results to expect in a similar situation.
I did not doctor this in any way and left it as is, warts and all.
